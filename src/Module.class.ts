...
export class ModuleClass {
    ...
    public init() {
        ...
        let $next = $('<div class="page-nav-next page-nav"><i class="arrow material-icons">chevron_right</i></div>').on('click', goToNextPage);
        //  Arrow keyboard buttons can be used to navigate
        ...
        if (this.context.mode == 'view') {
            ...
            */
            ...
            $module_edit_button.on('click', async () => {
                ...
                window.eq.popup({
                    entity: 'qursus\\Module', type: 'form', mode: 'edit', domain: ['id', '=', this.id], lang: environment.lang, callback: (data: any) => {
            ...
            $module_add_button.on('click', () => {
                ...
                window.eq.popup({
                    entity: 'qursus\\Chapter', type: 'form', mode: 'edit', purpose: 'create', domain: [['module_id', '=', this.id], ['identifier', '=', chapter_identifier], ['order', '=', chapter_identifier]], callback: (data: any) => {
